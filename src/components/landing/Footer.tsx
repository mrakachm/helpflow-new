    ...
    <footer className="mx-auto w-full max-w-6xl px-6 pb-10">
      <div className="rounded-[2rem] bg-slate-950 p-8 text-white shadow-lg">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            <h3 className="font-bold">Jalin Livraison au quotidien</h3>

            <p className="mt-4 text-sm leading-6 text-slate-300">
              Marchés, commerces locaux, proches, commandes, objets oubliés,
              achats entre particuliers et livraisons de proximité.
            </p>
          </div>
        </div>
