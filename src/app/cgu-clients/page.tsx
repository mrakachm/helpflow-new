...
Toute création de compte, demande de mission, paiement ou utilisation de la plateforme implique l’acceptation pleine et entière des présentes Conditions Générales d’Utilisation.

Le client déclare avoir lu, compris et accepté les présentes conditions avant de commander une mission.
...
Le client doit indiquer clairement :

* l’adresse de départ ;
* l’adresse d’arrivée ;
* le type de colis ou d’objet ;
* le volume ou la taille approximative ;
* les contraintes particulières ;
* le numéro de téléphone utile ;
* toute information nécessaire au bon déroulement de la mission.

Le client reste responsable de l’exactitude des informations communiquées.

5. Objets interdits

Il est strictement interdit de confier au livreur :

* argent liquide important ;
* armes ;
...
* animaux vivants, sauf accord spécifique ;
* objets volés ;
...
Le paiement est effectué en ligne via Stripe.
...
* du contenu confié au livreur ;
* de l’exactitude des adresses ;
* de la disponibilité au départ et à l’arrivée ;
* du respect de la loi ;
* de la remise d’un colis conforme à la description.
...
Le client peut annuler une mission selon l’état d’avancement.
...
Un remboursement peut être étudié en cas de paiement confirmé sans exécution effective de la mission.

Aucun remboursement automatique n’est dû lorsque l’échec de la mission provient d’une erreur du client, d’une absence du client ou d’informations incorrectes.

14. Code OTP de livraison

Un code de validation peut être fourni au client.

Le client doit communiquer ce code uniquement lorsque la mission est correctement terminée.

La communication du code au livreur vaut confirmation de livraison.

15. Comportement des utilisateurs

Le client s’engage à rester respectueux envers les livreurs, le support et les autres utilisateurs.

Tout comportement insultant, menaçant, frauduleux ou dangereux peut entraîner la suspension du compte.
...
En cas de litige, les parties tenteront d’abord de rechercher une solution amiable.

21. Acceptation

En cochant la case prévue lors de l’inscription ou de la commande, le client confirme accepter les présentes Conditions Générales d’Utilisation.
