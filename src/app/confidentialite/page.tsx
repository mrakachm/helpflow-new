...
* créer les comptes ;
* gérer les missions ;
* permettre la mise en relation client/livreur ;
* gérer les paiements ;
...
Les documents d’identité des livreurs sont collectés uniquement pour vérifier leur identité et sécuriser la plateforme.

L’accès à ces documents est limité aux personnes autorisées.

7. Conservation

Les données sont conservées pendant la durée nécessaire au fonctionnement du service, puis supprimées ou archivées selon les obligations légales applicables.
...
* l’hébergeur technique ;
* les prestataires nécessaires au fonctionnement ;
...
11. Contact données personnelles
