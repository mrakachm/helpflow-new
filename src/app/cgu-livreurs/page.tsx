export default function CGULivreursPage() {
  return (
...
L’inscription comme livreur implique l’acceptation complète des présentes Conditions Générales d’Utilisation Livreurs.

Le livreur déclare avoir lu, compris et accepté les présentes conditions avant d’utiliser la plateforme.
...
Le livreur est seul responsable de ses obligations sociales, fiscales, administratives et professionnelles.

4. Inscription livreur

Le livreur doit fournir des informations exactes :
...
Le livreur déclare disposer d’une assurance adaptée à son activité, à son véhicule et aux missions réalisées.

Le livreur reste seul responsable en cas d’absence, d’insuffisance ou d’expiration de son assurance.

7. Véhicule et matériel

Le livreur est responsable :

* de son véhicule ;
* de son entretien ;
* de sa conformité ;
* de son permis si nécessaire ;
* de son équipement ;
* de sa sécurité.
...
Le livreur s’engage à respecter :

* le Code de la route ;
* les règles de sécurité ;
* les règles de stationnement ;
* les règles applicables au transport ;
* les présentes conditions.

Toute conduite dangereuse peut entraîner une suspension immédiate.

9. Acceptation des missions

Le livreur est libre d’accepter ou non une mission.

Une fois la mission acceptée, le livreur s’engage à l’exécuter sérieusement, dans les meilleures conditions possibles.

10. Refus ou abandon de mission
...
Le livreur ne doit pas accepter de transporter des objets manifestement interdits, dangereux, suspects ou illégaux.

En cas de doute, le livreur doit refuser la mission ou contacter le support.

12. Responsabilité du livreur

Le livreur est responsable :

* de la bonne exécution de la mission ;
* du respect des instructions raisonnables ;
* de la sécurité du colis pendant la mission ;
* de son comportement ;
* de ses actes, fautes, retards ou négligences.

13. Vol, perte ou dommage
...
Le montant restant est reversé au livreur selon les modalités du prestataire de paiement.
...
Le livreur s’engage à rester poli, respectueux et professionnel.
...
En cas de litige, une solution amiable sera recherchée avant toute procédure.

23. Acceptation

En cochant la case prévue lors de l’inscription, le livreur confirme accepter les présentes Conditions Générales d’Utilisation Livreurs.
